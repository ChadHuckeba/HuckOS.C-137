...
* **Data Vectors:**
    ...
    * **Declarative Manifests:** Cataloging technical facts and project specifications.
* **System Logic:** Decouple immutable core protocols from iterative variables to stabilize agentic profiling for adaptive tutoring.
